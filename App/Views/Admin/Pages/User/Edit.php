                            ...
                            <form class="form-horizontal" action="/admin/users/<?= $data['id'] ?>" method="POST" enctype="multipart/form-data">
                                <div class="card-body">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="email" class="form-control" id="email" placeholder="Nhập tên người dùng..." name="email" value="<?= $data['email'] ?>" >
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="file" class="form-control" id="avatar" placeholder="Nhập lại mật khẩu người dùng..." name="avatar" value="<?= $data['avatar'] ?>" >
                                    </div>
                                    <div class="form-group">
